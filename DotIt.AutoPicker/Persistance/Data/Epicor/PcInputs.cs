...
{
    public partial class PcInputs
    {
        public PcInputs()
        {
            PcInputsLayerHeader = new HashSet<PcInputsLayerHeader>();
            PcInputsRule = new HashSet<PcInputsRule>();
            QbuildObj = new HashSet<QbuildObj>();
        }
        ...
        public virtual ICollection<PcInputsLayerHeader> PcInputsLayerHeader { get; set; }
        public virtual ICollection<PcInputsRule> PcInputsRule { get; set; }
        public virtual ICollection<QbuildObj> QbuildObj { get; set; }
    }
}

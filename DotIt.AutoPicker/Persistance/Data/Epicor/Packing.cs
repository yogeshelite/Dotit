...
namespace DotIt.AutoPicker.Persistance.Data.Epicor
{
    public partial class Packing
    {
        public Packing()
        {
            PackingPlant = new HashSet<PackingPlant>();
            PackingShipTo = new HashSet<PackingShipTo>();
        }
        ...
        public virtual ICollection<PackingPlant> PackingPlant { get; set; }
        public virtual ICollection<PackingShipTo> PackingShipTo { get; set; }
    }
}

...
{
    public partial class EsScenariodefaultsdtl
    {
        public string Company { get; set; }
        public string RecId { get; set; }
        public int? LineNumber { get; set; }
        public string ScenarioDefaultsDtlUserId { get; set; }
        public string ScenarioDefaultsDtlDesc { get; set; }
        public string ScenarioDefaultId { get; set; }
        public string DefaultPressId { get; set; }
        public string PressDefaultUserId { get; set; }
        public string PressDesc { get; set; }
        public string PrepressDefaultId { get; set; }
        public string PrepressDefaultUserId { get; set; }
        public string PrepressDefaultsDesc { get; set; }
        public string FinishingDefaultId { get; set; }
        public string FinishingDefaultUserId { get; set; }
        public string FinishingDefaultsDesc { get; set; }
        public bool? IncludeColorBar { get; set; }
        public bool? Inactive { get; set; }
        public int? OrderInEst { get; set; }
        ...
        public virtual EsPress DefaultPress { get; set; }
        public virtual EsFinishingdefaults FinishingDefault { get; set; }
        public virtual EsFolding Folder { get; set; }
        public virtual EsCutting PostpressCutter { get; set; }
        public virtual EsCutting PrepressCutter { get; set; }
        public virtual EsPrepressdefaults PrepressDefault { get; set; }
        public virtual EsScenariodefaults ScenarioDefault { get; set; }
    }
}

...
{
    public partial class EsPricingschemahead
    {
        public EsPricingschemahead()
        {
            EsEstimation = new HashSet<EsEstimation>();
            EsEstprefs = new HashSet<EsEstprefs>();
            EsPricingschemadtl = new HashSet<EsPricingschemadtl>();
        }

        public string RecId { get; set; }
        public string Company { get; set; }
        public string PricingSchemaHeadUserId { get; set; }
        ...
        public bool? IsDtlLines { get; set; }
        ...
        public virtual ICollection<EsPricingschemadtl> EsPricingschemadtl { get; set; }
    }
}

...
{
    public partial class ImesPrintingwizardtotals
    {
        ...
        public string PrepressHr { get; set; }
        public string PressHr { get; set; }
        public string FinishHr { get; set; }
        public string ValueAdded { get; set; }
        public string ValueAddedPct { get; set; }
        public string StockPrice { get; set; }
        public string OtherMatPrice { get; set; }
        public string PrepressPrice { get; set; }

...
{
    public partial class GljrnDtlMnl
    {
        public GljrnDtlMnl()
        {
            GljrnDtlMnlDeasch = new HashSet<GljrnDtlMnlDeasch>();
        }
        ...
        public string PartOfDual { get; set; }
        public string ReportingModule { get; set; }
        public string TaxableAmtBookCurr { get; set; }
        public string TaxableAmtCurr { get; set; }
        public decimal TaxableAmtInBookCurr { get; set; }
        public decimal TaxableAmtInTranCurr { get; set; }
        public string TaxableLine { get; set; }
        ...
        public bool OverrideGlacct { get; set; }
        ...
        public virtual ICollection<GljrnDtlMnlDeasch> GljrnDtlMnlDeasch { get; set; }
    }
}

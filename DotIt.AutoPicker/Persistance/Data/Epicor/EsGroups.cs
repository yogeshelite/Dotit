...
namespace DotIt.AutoPicker.Persistance.Data.Epicor
{
    public partial class EsGroups
    {
        ...
        public string GroupsUserId { get; set; }
        ...
        public string OrderInStdtype { get; set; }
        public string EstDisplayGroup { get; set; }
        public string EstDisplayGroupOrder { get; set; }
        public int? RowVersion { get; set; }
        public int? TableVersion { get; set; }
        public Guid SysRowId { get; set; }
        public byte[] SysRevId { get; set; }
        public string PrimaryStdInGroupId { get; set; }
        public string PrimaryStdInGroupUserId { get; set; }
        ...
        public virtual ICollection<EsInline> EsInline { get; set; }

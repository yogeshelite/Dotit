...
{
    public partial class ImesDynamiccombos
    {
        ...
        public string Dcuiname { get; set; }
        public string Dccode { get; set; }
        public string Dcdescription { get; set; }
        public string DcorderInGroup { get; set; }
        public bool? Dcinactive { get; set; }
        public int? RowVersion { get; set; }
        public int? TableVersion { get; set; }
        public Guid SysRowId { get; set; }
        public byte[] SysRevId { get; set; }
        public string DecProps { get; set; }
        public string CharProps { get; set; }
        public string DateProps { get; set; }
        public string IntProps { get; set; }
        public string LogicalProps { get; set; }

...
{
    public partial class EsFoldtag
    {
        public EsFoldtag()
        {
            EsFoldtagpref = new HashSet<EsFoldtagpref>();
        }
        ...
        public int? NumFoldsRightAngle { get; set; }
        ...
        public virtual ICollection<EsFoldtagpref> EsFoldtagpref { get; set; }
    }
}

...
{
    public partial class EsInlinefinish
    {
        public string Company { get; set; }
        public string RecId { get; set; }
        public string InlineId { get; set; }
        public string InlineFinishUserId { get; set; }
        public string InlineFinishDesc { get; set; }
        public string FinishingRecId { get; set; }
        public int? OrderSeq { get; set; }
        public string GroupId { get; set; }
        public string TopLevelUserId { get; set; }
        public bool? AutoAdd { get; set; }
        public string InlineComboList { get; set; }
        public int? IsFeederInlineAutoAdd { get; set; }
        ...
        public virtual EsFinishing FinishingRec { get; set; }

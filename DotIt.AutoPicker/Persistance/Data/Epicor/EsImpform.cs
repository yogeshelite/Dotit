...
{
    public partial class EsImpform
    {
        public EsImpform()
        {
        ...
        public int? NumPgWidth { get; set; }
        public int? NumPgLength { get; set; }
        public int? TotalPgForm { get; set; }
        public string FormNumUi { get; set; }
        public int? NumOut { get; set; }
        public string ImpFormSummary { get; set; }
        public decimal? FormUtilization { get; set; }
        public decimal? FormW { get; set; }
        public decimal? FormL { get; set; }
        ...
        public string FwebFormId { get; set; }
        ...
        public virtual EsPressfwebform FwebForm { get; set; }

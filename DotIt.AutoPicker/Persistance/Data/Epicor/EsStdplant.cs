...
{
    public partial class EsStdplant
    {
        public EsStdplant()
        {
        ...
        public string FinsihingRecId { get; set; }
        public string FinishingUserId { get; set; }
        public string InlineRecId { get; set; }
        ...
        public string FinishingOperationId { get; set; }
        public string HelperSchedResourceIdcombo { get; set; }
        ...
        public bool? InlineResGroupIsHelper { get; set; }

        public virtual EsFinishing FinsihingRec { get; set; }
        public virtual EsInline InlineRec { get; set; }

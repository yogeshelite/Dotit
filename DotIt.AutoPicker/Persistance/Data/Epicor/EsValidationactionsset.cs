...
{
    public partial class EsValidationactionsset
    {
        public EsValidationactionsset()
        {
            EsMessageactions = new HashSet<EsMessageactions>();
            EsSetpropertyactions = new HashSet<EsSetpropertyactions>();
        }
        ...
        public string ValidationTableName { get; set; }
        public string ValidationRecId { get; set; }
        public string ValidationFieldIndexes { get; set; }
        public string PartId { get; set; }
        public string EstimateId { get; set; }
        public int? QuoteNum { get; set; }
        public bool? WizardOption { get; set; }
        ...
        public virtual ICollection<EsMessageactions> EsMessageactions { get; set; }
        public virtual ICollection<EsSetpropertyactions> EsSetpropertyactions { get; set; }
    }
}

...
{
    public partial class EsInlinefold
    {
        public string Company { get; set; }
        public string RecId { get; set; }
        public string InlineId { get; set; }
        public string InlineFoldUserId { get; set; }
        public string InlineFoldDesc { get; set; }
        public string FoldingRecId { get; set; }
        ...
        public virtual EsFolding FoldingRec { get; set; }

...
{
    public partial class EsPricingschemadtl
    {
        public string Company { get; set; }
        public string RecId { get; set; }
        public int? SchemaLineNum { get; set; }
        public string SchemaId { get; set; }
        public decimal? BreakFrom { get; set; }
        public decimal? BreakTo { get; set; }
        public string TargetTypeUi { get; set; }
        public string TargetType { get; set; }
        public string ValueTypeUi { get; set; }
        public string ValueType { get; set; }
        public decimal? TargetValue { get; set; }
        public decimal? TotalTargetValue { get; set; }
        public decimal? LaborMarkup { get; set; }
        public decimal? MatMarkup { get; set; }
        public decimal? OverallMarkup { get; set; }
        public decimal? SalesCommissionMarkup { get; set; }
        public decimal? AddlMarkup1 { get; set; }
        public decimal? AddlMarkup2 { get; set; }
        public string BreakLevelBasis { get; set; }
        public bool? InValidPctValue { get; set; }

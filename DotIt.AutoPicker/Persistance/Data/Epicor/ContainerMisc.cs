...
{
    public partial class ContainerMisc
    {
        public ContainerMisc()
        {
            ContainerMiscTax = new HashSet<ContainerMiscTax>();
        }
        ...
        public virtual ICollection<ContainerMiscTax> ContainerMiscTax { get; set; }
    }
}

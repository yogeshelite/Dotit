...
{
    public partial class EsPartsbf
    {
        public string Company { get; set; }
        public string RecId { get; set; }
        public string PartId { get; set; }
        public string EstimateId { get; set; }
        public string PidefaultsSbfid { get; set; }
        public string Sbfid { get; set; }
        public string SbfuserId { get; set; }
        public string Sbfside { get; set; }
        public int? Sbfpos { get; set; }
        public string Comments { get; set; }
        public int? SbfidSttc { get; set; }
        public int? SbfsideSttc { get; set; }
        ...
        public virtual EsFolding Sbf { get; set; }
    }
}

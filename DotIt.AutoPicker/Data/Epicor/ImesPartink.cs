...
{
    public partial class ImesPartink
    {
        ...
        public string PidefaultsInkId { get; set; }
        public string InkId { get; set; }
        public string InkUserId { get; set; }
        public string InkDesc { get; set; }
        public string InkSide { get; set; }
        public decimal InkFront { get; set; }
        public decimal InkBack { get; set; }
        public int? InkPos { get; set; }
        public string Comments { get; set; }
        public string TopLevelUserId { get; set; }
        public int? InkIdSttc { get; set; }
        public int? InkDescSttc { get; set; }
        public int? InkSideSttc { get; set; }
        public int? InkFrontSttc { get; set; }
        public int? InkBackSttc { get; set; }

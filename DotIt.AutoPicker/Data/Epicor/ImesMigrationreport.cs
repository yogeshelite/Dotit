...
{
    public partial class ImesMigrationreport
    {
        ...
        public string UpdatedColumnName { get; set; }
        public string UpdatedRecordId { get; set; }
        public string UpdatedRecordUserId { get; set; }

...
{
    public partial class EsInlinecut
    {
        public string Company { get; set; }
        public string RecId { get; set; }
        public string InlineId { get; set; }
        public string InlineCutUserId { get; set; }
        public string InlineCutDesc { get; set; }
        public string CuttingRecId { get; set; }
        ...
        public virtual EsCutting CuttingRec { get; set; }

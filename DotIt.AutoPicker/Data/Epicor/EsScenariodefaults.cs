...
{
    public partial class EsScenariodefaults
    {
        public EsScenariodefaults()
        {
        ...
        public bool? UseRoundToShts { get; set; }
        public int? RoundToShts { get; set; }
        public bool? IncludeShtsInPressRun { get; set; }
        public bool? UseRoundToWeightRollStock { get; set; }
        public int? RoundToWeightRollStock { get; set; }
        public bool? IncludeWeightOfRollInPresRun { get; set; }
        public bool? RoundBinderyOnlyShts { get; set; }
        public int? BinderyRoundToShts { get; set; }
        public string PressSetupAdjModifies { get; set; }
        public bool? Inactive { get; set; }
        public string OrderInEst { get; set; }
        public string UirecIdentifier { get; set; }
        public int? RowVersion { get; set; }
        public int? TableVersion { get; set; }
        public string AllDigitalOrOffset { get; set; }

...
{
    public partial class ImglbSalesTax
    {
        ...
        public string EinvTaxCategory { get; set; }
        public string PeisccalcCode { get; set; }
        public string PeallowanceChargeReasonCode { get; set; }
    }
}

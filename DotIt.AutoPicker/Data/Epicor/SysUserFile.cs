...
{
    public partial class SysUserFile
    {
        public SysUserFile()
        {
            ContextType = new HashSet<ContextType>();
            FavFolder = new HashSet<FavFolder>();
            HomeUserOption = new HashSet<HomeUserOption>();
        ...
        public virtual UserTracing UserTracing { get; set; }
        public virtual ICollection<ContextType> ContextType { get; set; }
        public virtual ICollection<FavFolder> FavFolder { get; set; }
        public virtual ICollection<HomeUserOption> HomeUserOption { get; set; }

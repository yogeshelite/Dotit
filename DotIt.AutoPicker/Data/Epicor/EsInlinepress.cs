...
{
    public partial class EsInlinepress
    {
        public string Company { get; set; }
        public string RecId { get; set; }
        public string InlineId { get; set; }
        public string InlinePressUserId { get; set; }
        public string InlinePressDesc { get; set; }
        public string PressRecId { get; set; }
        public int? OrderSeq { get; set; }
        public string GroupId { get; set; }
        public string RelatedPressOperation { get; set; }
        public string InlineComboText { get; set; }
        public string TopLevelUserId { get; set; }
        public bool? AutoAdd { get; set; }
        public bool? IsSpotBlanketInline { get; set; }
        public bool? IsOverallBlanketInline { get; set; }
        ...
        public virtual EsInline Inline { get; set; }
        public virtual EsPress PressRec { get; set; }
    }
}

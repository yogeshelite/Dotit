...
namespace DotIt.AutoPickerApi.Service
{
    public interface IEpicorServiceApi
    {
        ...
        Task<List<OrderHeadModel>> GetEpicoreOrderAsync();
        Task<List<PartBinModel>> GetPartBinAsync(string partnum);
        Task<List<PartsModel>> GetPartsAsync();
        Task<List<OrderDetailModel>> GetEpicorOrderDetailsAsync(string[] Orders);
        Task<string> GetPartBinLocationAsync(OrderDetailModel _Order);
        Task<string> GetItemImageByPartNumberAsync(string partNum);
    }


    public class EpicorServiceApi:IEpicorServiceApi
    {
        IEpicorRepository _epicorRepository;
        public EpicorServiceApi()
        {

        }
        public EpicorServiceApi(IEpicorRepository epicorRepository)
        {
            _epicorRepository = epicorRepository;
        }
        ...
        public async Task<List<OrderHeadModel>> GetEpicoreOrderAsync()
        {
            ...
            using (_apiResponse = new ApiResponse())
            {
                try
                {
                    ...
                    ResponseModel ObjResponse = await _apiResponse.GetApiResponseAsync(string.Format(Constant.EpicorApi.SalesOrderFilter, "true", dt), "GET");
                    //ResponseModel ObjResponse = _apiResponse.GetApiResponse(Constant.EpicorApi.SalesOrderFilter, "GET");
        ...
        public async Task<List<PartBinModel>> GetPartBinAsync(string partnum)
        {
            ...
            using (_apiResponse = new ApiResponse())
            {
                try
                {
                    ...
                    ResponseModel ObjResponse = await _apiResponse.GetApiResponseAsync(Constant.EpicorApi.PartBinSearch, "post", inputJson);
                    if (ObjResponse.Success == true)
                    {
                        var OrderDetails = JsonConvert.DeserializeObject<Dictionary<string, object>>(ObjResponse.Response);
        ...
        public async Task<List<PartsModel>> GetPartsAsync()
        {
            ...
            using (_apiResponse = new ApiResponse())
            {
                try
                {
                    ResponseModel ObjResponse = await _apiResponse.GetApiResponseAsync(Constant.EpicorApi.Parts, "GET");
                    if (ObjResponse.Success == true)
                    {
                        var OrderDetails = JsonConvert.DeserializeObject<Dictionary<string, object>>(ObjResponse.Response);
                        if (OrderDetails.ContainsKey("value"))
        ...
        //        using (_apiResponse = new ApiResponse())
        //        {
        //            ResponseModel ObjResponse = _apiResponse.GetApiResponse(Constant.EpicorApi.OrderDetails, "GET");
        //            var OrderDetails = JsonConvert.DeserializeObject<Dictionary<string, object>>(ObjResponse.Response);
        ...
        public async Task<List<OrderDetailModel>> GetEpicorOrderDetailsAsync(string[] Orders)
        {
            ...
            try
            {
                ...
                {
                    // var data = JsonConvert.DeserializeObject<string[]>(Orders);
                    ResponseModel ObjResponse = await _apiResponse.GetApiResponseAsync(Constant.EpicorApi.OrderDetails, "GET");
                    if (ObjResponse.Success == true)
                    {
        ...
        public async Task<string> GetPartBinLocationAsync(OrderDetailModel _Order)
        {
            ...
            _Response = await _apiResponse.GetApiResponseAsync(Constant.EpicorApi.PartBinSearchSvc, "POST", "{\"partNum\":'" + _Order.PartNum + "',\"whseCode\":''}");
        ...
        public async Task<string> GetItemImageByPartNumberAsync(string partNum)
        {
            ...
            return await _epicorRepository.GetItemImageByPartNumberAsync(partNum);
            ...
            //    ResponseModel ObjResponse = await _apiResponse.GetApiResponseAsync(string.Format(Constant.EpicorApi.Image,, "GET");




            //        = await _apiResponse.GetApiResponseAsync(string.Format(Constant.EpicorApi.Image,, "GET");
